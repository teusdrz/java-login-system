...
public class AuthController {
    ...
    private void handleLoggedInMenu() {
        consoleView.displayLoggedInMenu(currentUser);
    ...
    private void handleLogin() {
        consoleView.displaySectionHeader("LOGIN");
        ...
        if (user != null) {
            ...
            // Display user info
            consoleView.displayUserInfo(user);
    ...
    private void handleRegistration() {
        consoleView.displaySectionHeader("USER REGISTRATION");
        ...
        Role role = userDatabase.isEmpty() ? Role.ADMIN : Role.USER;
        ...
        if (result == RegistrationResult.SUCCESS) {
            ...
            consoleView.displayErrorMessage("Registration failed: " + result.getDescription());
        }
    }
